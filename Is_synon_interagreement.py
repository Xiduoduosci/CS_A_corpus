...
for file_name in os.listdir(base_path1):
    ...
    print(url2)
    ann1_label = ann1[ann1[1].str.startswith('Is_synon')]

    ann2_label = ann2[ann2[1].str.startswith('Is_synon')]
    print(ann2_label)
    ...
    for i in range(len(stand_label)):
        ...
        str1 = process_label[1]
        str2 = process_label[2]
    ...
    for i in range(len(constrast_label)):
        ...
        constrast_str1 = constrast_process_label[1]
        constrast_str2 = constrast_process_label[2]
