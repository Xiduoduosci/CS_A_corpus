...
base_path2 = "F:/小论文1实验数据/corpus_final/corpus_annotation_zhao_v3/"
ann1_en = 0
ann2_en = 0
IAA_count = 0
...
for file_name in os.listdir(base_path1):
    ...
    print(url2)
    # print(ann2[1].str.startswith('Anaphor'))
    ann1_label = ann1[ann1[1].str.startswith('Anaphor')]
    ann2_label = ann2[ann2[1].str.startswith('Anaphor')]
